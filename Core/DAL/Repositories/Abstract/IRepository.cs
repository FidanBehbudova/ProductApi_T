...
namespace ProductApi.Core.DAL.Repositories.Abstract
{
        ...
        where TEntity : class,new()
    {
        ...
        public Task<List<TEntity>> GetPaginateAsync(int page, int size, Expression<Func<TEntity, bool>> filter = null, params string[] includes);
